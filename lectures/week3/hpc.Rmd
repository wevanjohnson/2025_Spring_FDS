...
For the next lecture you will need to install git and get a GitHub account. \vskip .1in

After installing git, go get a GitHub account. Go to [https://github.com/](https://github.com/). You will see a link to sign up in the top right corner. \vskip .1in
