...
date: Due Wednesday, February 19th, 2025
output: pdf_document
---
...
1.\ (10 points) Learn more about the **scan**, **readLines**, **read\_html**, **readr**, and **readxl** functions for getting data into R. Use the data into a tibble using R.  How are these different from the functions we learned in class? Report what you find and give some examples!
...
\subsection*{R Markdown (30 points)}
